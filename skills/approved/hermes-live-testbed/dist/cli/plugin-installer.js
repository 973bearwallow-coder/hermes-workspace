...
export async function pluginInstallStatus(options = {}) {
    const normalized = normalizePluginOptions(options);
    const source = pluginSourceDir();
    const target = pluginTargetDir(normalized);
...
export function pluginTargetDir(options = {}) {
    return join(hermesPluginsDir(options), "hermes-live");
}
export function hermesPluginsDir(options = {}) {
...
async function assertPluginSource(source) {
