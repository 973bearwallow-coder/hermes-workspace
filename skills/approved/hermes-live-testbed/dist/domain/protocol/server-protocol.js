import { z } from "zod";
import { NotificationIdSchema, RequestIdSchema, TASK_LIST_MAX_LIMIT, TaskIdSchema, TaskSequenceSchema, } from "./client-protocol.js";
...
export function serverMessage(value) {
