...
import { u as isCodexAppServerPrewriteRequestCancellationError } from "./client-B57KWPQx.js";
...
import { J as retainCodexAppServerLiveThread, R as consumeCodexAppServerLiveThread, c as getLeasedSharedCodexAppServerClient, h as releaseLeasedSharedCodexAppServerClient } from "./shared-client-CscigXXL.js";
import { _ as readCodexNotificationTurnId, a as closeCodexStartupClientBestEffort, c as isCodexNoActiveTurnInterruptError, d as unsubscribeCodexThreadBestEffort, g as readCodexNotificationThreadId, r as CodexAppServerUnsafeSubscriptionError } from "./attempt-client-cleanup-DKHzbwt5.js";
import { s as readCodexNotificationItem } from "./attempt-notifications-C9XufG6l.js";
import { n as readCodexThreadContextSnapshot } from "./event-projector-usage-BfXmpOec.js";
import { o as resolveCodexSessionBinding, t as CODEX_APP_SERVER_BINDING_GUARDED_REQUEST_TIMEOUT_MS } from "./session-binding-CI8UuilT.js";
...
import { t as isSameCodexAppServerThreadOwner } from "./thread-ownership-BsDRTsyp.js";
import { t as persistCodexContextCompactionActivity } from "./context-compaction-activity-CMla5FPJ.js";
...
async function compactCodexNativeThread(params, options) {
	...
	try {
		...
		connection = resolveCodexBindingAppServerConnection({
			...
			config,
			agentDir: resolveAgentDir$1(config, agentId)
		});
	} catch (error) {
		return {
			ok: false,
